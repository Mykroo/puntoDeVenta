...
String query = "select idProducto, codigo, descripcion, marca, categoria, round(precioVenta,2),stock from producto natural join categorias natural join marcas where codigo = '"+codigo+"' and activo = 1;";
