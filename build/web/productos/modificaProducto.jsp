...
<%
    ...
    if(n>0){
        ...
        query = "update producto set codigo = "+codigo+", descripcion = '"+descripcion+"', idproveedor = "+proveedor+", precioVenta = "+precioVenta+", idcategoria = "+categoria+", idmarca = "+marca+"  where idProducto = "+idProducto+ ";";
        System.out.println(query); 
