                    ...
                    +"<table id='tablaMarcas' class='table table-striped table-bordered table-hover'>"
                        ...
                        +"<tbody>";
                            ...
                            for(int i=0;i< n;i++){                                
                                ...
                                salida += "<td><span class='glyphicon glyphicon-pencil' onclick='idMarcaModificar = \""+objConn.rs.getString(1)+"\";' data-toggle=\"modal\" href=\'#modal-modificar\'></span></td>"
                                        + "<td><span class='icon-cross' onclick='idMarcaEliminar = \""+objConn.rs.getString(1)+"\";' data-toggle=\"modal\" href=\'#modal-eliminar\'></span></td>";
                                salida+="</tr>";                                   
                                objConn.rs.next(); 
                            }                           
                        salida+="</tbody>"
