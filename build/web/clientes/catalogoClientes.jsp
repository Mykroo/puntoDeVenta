...
<%         
    ...
    String query = "select idcliente,nombre,apellidoPaterno, apellidoMaterno,telefono, email, calle , numero, colonia, municipio, estado, cp, ucase(rfc) from cliente natural join estados natural join municipios where activo = 1 and idCliente != 1;";
    ...
    salida += "<div class=\"table-responsive datagrid\">"
           +  "<table id=\"tablaClientes\" class=\"table table-striped table-bordered table-hover\">"
               ...
               salida += " <h3>No hay clientes registrados</h3>";                    
               json.put("tabla", salida);            
            }       
            objConn.desConnect();
            out.print(json);
