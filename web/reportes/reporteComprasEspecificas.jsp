...
String query = "select c.idcompratotal,fechaespanol(date(c.fecha)) as fecha,c.folioNota,concat_ws(' ',p.nombre,p.apellidoPaterno,p.apellidoMaterno) as proveedor,c.total from compratotal c natural join proveedor p where date(fecha) between '"+fechaInicial+"' and '"+fechaFinal+"' and p.activo=1";
